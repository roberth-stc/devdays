...
<html>
    ...
    <body>
        ...
        <div id="show-training" class="content scaffold-show" role="main">
            ...
            <f:display bean="training" />
            <g:form resource="${this.training}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.training}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
